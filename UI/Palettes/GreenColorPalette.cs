...
namespace JapaneseCrossword.UI.Palettes {
	public struct GreenColorPalette : IColorPalette {

		//
		// Palette
		//

		public static readonly Color Default = ColorTranslator.FromHtml("#E9F5DB");

		public static readonly Color AccentLightLight = ColorTranslator.FromHtml("#80CFE1B9");
		public static readonly Color AccentLight = ColorTranslator.FromHtml("#B5C99A");
		public static readonly Color Accent = ColorTranslator.FromHtml("#97A97C");
		public static readonly Color AccentDark = ColorTranslator.FromHtml("#87986A");
		public static readonly Color AccentDarkDark = ColorTranslator.FromHtml("#718355");
